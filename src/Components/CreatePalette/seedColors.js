const seedColors = [
  ...
  {
    paletteName: "Dull Machine",
    id: "dull-machine",
    emoji: "😴",

    colors: [
      { name: "CottonCandyPink", color: "#ffb7c5" },
      { name: "LavenderBlush", color: "#f5c6e0" },
      { name: "MintGreen", color: "#a2ded0" },
      { name: "PeachyKeen", color: "#ffc2a1" },
      { name: "BabyBlue", color: "#a3c4bc" },
      { name: "LemonMeringue", color: "#fff3a5" },
      { name: "Periwinkle", color: "#c3bef0" },
      { name: "LilacLove", color: "#e8d3f9" },
      { name: "BubblegumBlue", color: "#e0d3e4" },
      { name: "MellowYellow", color: "#f9f7a1" },
      { name: "MintCream", color: "#f3ffe1" },
      { name: "CoralCrush", color: "#f7a399" },
      { name: "PalePink", color: "#f9dcdc" },
      { name: "SeafoamGreen", color: "#c8f7c5" },
      { name: "ButtercupYellow", color: "#fbf7d5" },
      { name: "IcyMint", color: "#d2f5e3" },
      { name: "SoftLilac", color: "#ede8f4" },
      { name: "CreamsicleOrange", color: "#ffe5b4" },
      { name: "PowderBlue", color: "#d8eaf1" },
      { name: "PistachioGreen", color: "#d6ecd1" },
    ],
  },
  {
    paletteName: "Not So Average",
    id: "not-so-average",
    emoji: "😌",
    colors: [
  ...
  },
  {
    ...
    emoji: "🧡",
    colors: [
      { name: "CrimsonRed", color: "#e74c3c" },
      { name: "SunshineYellow", color: "#f1c40f" },
      { name: "EmeraldGreen", color: "#2ecc71" },
      { name: "RoyalBlue", color: "#3498db" },
      { name: "PurpleHaze", color: "#9b59b6" },
      { name: "CoralPink", color: "#ff6b6b" },
      { name: "TangerineOrange", color: "#ff9f43" },
      { name: "LimeGreen", color: "#7eff8b" },
      { name: "OceanBlue", color: "#0984e3" },
      { name: "BubblegumPink", color: "#fd79a8" },
      { name: "GoldenYellow", color: "#f9ca24" },
      { name: "Teal", color: "#1abc9c" },
      { name: "Indigo", color: "#6610f2" },
      { name: "Magenta", color: "#e84393" },
      { name: "LemonYellow", color: "#fdd835" },
      { name: "SkyBlue", color: "#7ed6df" },
      { name: "Lavender", color: "#a29bfe" },
      { name: "Peach", color: "#ff9ff3" },
      { name: "MidnightBlue", color: "#2c3e50" },
      { name: "Silver", color: "#dfe6e9" },
    ],
  },
  {
